<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentUpdate.aspx.cs" Inherits="SchoolExhibition.StudentUpdate" %>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group col-md-6">
                    <label class="col-sm-4 control-label" for="inputEmail3">Select Student <span style="color: red">*</span></label>
                    <div class="col-sm-8">
                        <asp:DropDownList ID="ddl_Student" Style="text-align: center;" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_Student_SelectedIndexChanged" AutoPostBack="True">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="form-group col-md-6">
